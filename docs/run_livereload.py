...
if __name__ == '__main__':
    ...
    server.watch('../flex_abac/*.py', shell('make html'), delay=1)
    server.watch('../flex_abac/utils/*.py', shell('make html'), delay=1)
    server.watch('../flex_abac/models/*.py', shell('make html'), delay=1)
